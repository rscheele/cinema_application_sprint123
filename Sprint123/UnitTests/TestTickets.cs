...
namespace UnitTests
{
    ...
    public class TestTickets
    {
        ...
        public void SetupRepositories()
        {
            ...
            Show showToAdd = new Show { ShowID = 1, BeginTime = DateTime.Parse("2018-03-29 14:40:00.000"), EndTime = DateTime.Parse("2018-03-29 16:10:00.000"), MovieID = 1, RoomID = 1, NumberofTickets = 11, ChildDiscount = true, StudentDiscount = true, SeniorDiscount = true, Movie = movie, Room = room };
            shows.Add(showToAdd);
            ...
            Show showToAdd2 = new Show { ShowID = 1, BeginTime = DateTime.Parse("2018-03-29 14:40:00.000"), EndTime = DateTime.Parse("2018-03-29 16:10:00.000"), MovieID = 1, RoomID = 1, NumberofTickets = 11, ChildDiscount = true, StudentDiscount = true, SeniorDiscount = true, Movie = movie2, Room = room };
