...
namespace UnitTests
{
    ...
    public class TestUpcomingShows
    {
        ...
        public void TestForUpcomingShows() {
            ...
            new Show{ShowID=4,BeginTime=DateTime.Parse("2018-03-29 14:45:00.000"),EndTime=DateTime.Parse("2018-03-29 16:55:00.000"), /*Movie={MovieID=3, Name = "Death Wish", Language = "Engels", LanguageSub = "Nederlands", Age = 16, MovieType = 2, Length = 108, Is3D = true, MainActors = "Bruce Willis", SubActors = "Vincent D'Onofrio, Elisabeth Shue", Director = "Eli Roth", LocationID = 1, Genre = "actie"},*/  MovieID=3,RoomID=3,NumberofTickets=1},
            });
